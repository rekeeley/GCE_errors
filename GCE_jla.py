...
plt.savefig('plots/WIMP/'+file_name+'_GCE_contours.pdf')
plt.clf()
...
plt.savefig('plots/WIMP/'+file_name+'_dwarf_contours.pdf')
plt.clf()
...
plt.savefig('plots/WIMP/'+file_name+'_cross_section_posteriors.pdf')
plt.clf()
