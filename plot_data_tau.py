...
MG_8 = np.loadtxt('output/approx2_tau_full_8_20.txt') #importing the data
MG_6 = np.loadtxt('output/approx2_tau_full_6_20.txt')
MG_10 = np.loadtxt('output/approx2_tau_full_10_20.txt')
z_8 = np.zeros((N1,N2))
z_6 = np.zeros((N1,N2))
z_10 = np.zeros((N1,N2))
for i in range(N1):
...
plt.savefig('write-up/tau_data.pdf')#plotting the data
plt.clf()
