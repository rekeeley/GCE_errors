...
MG_8 = np.loadtxt('output/approx2_bbar_full_8_20.txt') #importing the data
MG_6 = np.loadtxt('output/approx2_bbar_full_6_20.txt')
MG_10 = np.loadtxt('output/approx2_bbar_full_10_20.txt')
...
plt.savefig('write-up/bbar_data.pdf')#plotting the data
plt.clf()
