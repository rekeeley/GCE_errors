...
file_path = np.array(['spectra/binned_0215/tau/binned_spectra_','spectra/binned_0215/bbar/binned_spectra_'])[channel]

file_name = np.array([['tau_noxbulge','tau_xbulge'],
...
plt.errorbar(bin_center, k[0,0,0,:]-background, yerr=np.sqrt(k[0,0,0,:]), color='c', label='Observed Residual')
plt.plot(bin_center, mu[max_index_GCE[0],max_index_GCE[1],max_index_GCE[2],:]-background, 'm', label='Expected Residual')
plt.xscale('log')
plt.yscale('log')
plt.xlabel('Energy [GeV]')
plt.ylabel('Number Counts')
plt.legend(loc='best')
plt.savefig('plots/WIMP/0215/'+file_name+'_test_residuals_GCE.png')
plt.clf()
...
plt.savefig('plots/WIMP/0215/'+file_name+'_GCE_contours.pdf')
plt.clf()
...
for i in range(len(like_name)):
    ...
    plt.savefig('plots/WIMP/0215/'+file_name+'_'+name+'_contours.png')
    plt.clf()
...
plt.savefig('plots/WIMP/0215/'+file_name+'_dwarf_contours.pdf')
plt.clf()
...
plt.savefig('plots/WIMP/0215/'+file_name+'_cross_section_posteriors.pdf')
plt.clf()
...
plt.xlabel('Mass [GeV]')
plt.ylabel('Cross Section [cm^3 sec^-1]')
plt.savefig('plots/WIMP/0215/'+file_name+'_combo_contours.png')
plt.clf()
